...
class StockPriceHandler():
    def __init__(self):
        self._quandl_urls = {
            'gbtc' : 'http://download.finance.yahoo.com/d/quotes.csv?s=GBTC&f=sl1d1t1c1ohgv&e=.csv'
        }
    ...
    def get_csv(self):
        for key, val in self._quandl_urls.iteritems():
            ...
            file_dir = '/var/www/prjTheEdge-Beta-1.0/media/static/frontend/files/stock_market/bitcoin/{sub_dir}/'.format( sub_dir = key)
